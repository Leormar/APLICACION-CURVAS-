      ...
      try {
        ...
        if (existing.rows.length === 0) {
          ...
          await enviarEmail({
            ...
            html: '<div style="font-family:Arial,sans-serif;max-width:500px;margin:0 auto;padding:24px"><h2 style="color:#1e40af">Nueva solicitud</h2><p><strong>Nombre:</strong> ' + (name||email) + '</p><p><strong>Email:</strong> ' + email + '</p><a href="https://curvasdesenfoque.com/admin" style="display:inline-block;padding:12px 24px;background:#1e40af;color:white;border-radius:8px;text-decoration:none;font-weight:bold;margin-top:12px">Ver panel admin</a></div>'
          })
          return '/pendiente'
        }
